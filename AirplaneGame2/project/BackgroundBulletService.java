...
public class BackgroundBulletService {
	...
	public boolean leftWall() {
		...
		Color leftColor = new Color(image.getRGB(bullet.getX(), bullet.getY()));
		// R 255, G 0, B 0 <-- 빨간색
	...
	public boolean rightWall() {
		Color rightColor = new Color(image.getRGB(bullet.getX(), bullet.getY()));
	...
	public boolean topWall() {
		Color topColor = new Color(image.getRGB(bullet.getX(), bullet.getY()));
