...
//		}
	...
	private void initData() {
		gameStart = new JLabel(new ImageIcon("imagesProject/GameTitle.gif")); // 게임 시작화면
...
//						t.schedule(task1, 3000);
	...
	class MyPanel extends JPanel {
		...
		public MyPanel() {
			...
			setFocusable(true); // 사용하지 않아도 잘 작동함 (키보드 검증 50번)
		...
		protected void paintComponent(Graphics g) {
			...
			// Time클래스의 timeLabel을 참조하여 830, 20에 위치 지정
